...
import {  EyeOff,  Lock, LogIn, UserRound } from 'lucide-react-native';
              ...
              refreshControl={
                ...
                <View style={styles.LoginBody}>
                  ...
                  <Text style={{fontFamily:Fonts.light, fontSize:Size.md, width:'100%', textAlign:'center',
                    color:Colors.white,
                  }}>Enter credentials to Login</Text>
                ...
                <Text style={{fontFamily:Fonts.regular, fontSize:Size.sm, width:'100%', textAlign:'center',
                    color:Colors.darkButton, marginTop:20}}>You don't have an account?
                    <Text style={{fontFamily:Fonts.semiBold}} onPress={() => navigation.navigate('SignupScreen')}> Signup</Text> </Text>
            </ScrollView>
    </SafeAreaView>
  );
};
