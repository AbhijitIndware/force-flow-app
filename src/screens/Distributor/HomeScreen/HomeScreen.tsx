...
const DistributorHomeScreen = ({navigation}: Props) => {
  ...
  const {
    ...
    {from_date: fromDateStr, to_date: toDateStr},
...
const styles = StyleSheet.create({
  ...
  // User Manual
  manualSection: {paddingHorizontal: 20, marginTop: 16},
  manualCard: {
    backgroundColor: Colors.white,
    borderRadius: 16,
    paddingVertical: 6,
