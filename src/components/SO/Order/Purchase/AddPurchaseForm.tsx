...
const AddPurchaseForm: React.FC<Props> = ({
  values,
  errors,
  touched,
  handleChange,
  ...
  return (
    ...
    >
      ...
      <ReusableDropdown label="Group" field="distributor_group" value={values.distributor_group} data={distributorGroupList} error={touched.distributor_group && errors.distributor_group} onChange={(val: string) => onSelect('distributor_group', val)} />
      <ReusableDropdown label="Employee" field="employee" value={values.employee} data={employeeList} error={touched.employee && errors.employee} onChange={(val: string) => onSelect('employee', val)} />
      ...
      <ReusableDropdown label="Reports To" field="reports_to" value={values.reports_to} data={employeeList} error={touched.reports_to && errors.reports_to} onChange={(val: string) => onSelect('reports_to', val)} />
      <ReusableDropdown label="Designation" field="designation" value={values.designation} data={designationList} error={touched.designation && errors.designation} onChange={(val: string) => onSelect('designation', val)} />
      <ReusableInput label="Distributor Code" value={values.distributor_code} onChangeText={handleChange('distributor_code')} onBlur={()=>handleBlur('distributor_code')} error={touched.distributor_code && errors.distributor_code} />
