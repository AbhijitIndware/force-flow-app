    ...
    <ScrollView
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          style={[
            styles.submitBtn,
            (isSubmitLoading || order_details.status !== 'Draft') && {
              opacity: 0.7,
            },
          ]}
          onPress={() => handleSubmit()}
          disabled={isSubmitLoading || order_details.status !== 'Draft'}>
          {isSubmitLoading ? (
        ...
        <TouchableOpacity
          style={[
            styles.submitBtn,
            (isCancelLoading ||
              order_details.status !== 'To Deliver and Bill') && {
              opacity: 0.7,
            },
            {
          ...
          disabled={
            isCancelLoading || order_details.status !== 'To Deliver and Bill'
          }>
          {isCancelLoading ? (
            <ActivityIndicator size="small" color={Colors.white} />
          ) : (
